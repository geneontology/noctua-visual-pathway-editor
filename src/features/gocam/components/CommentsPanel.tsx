  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto bg-white">
          ...
          {modelComments.length === 0 ? (
            ...
            <div className="flex flex-col gap-1 px-3 py-2">
              {modelComments.map((comment, i) => (
                <div
                  key={i}
                  className="whitespace-pre-wrap break-words rounded-sm border-l-2 border-primary-300 bg-primary-50/40 px-2 py-1 text-xs text-gray-700"
                >
                  {comment}
                </div>
              ))}
        ...
        {/* ── Section B: Per-edge comments grouped by activity ── */}
        <section>
          ...
          {activitiesWithCommentedEdges.length === 0 ? (
            <div className="px-3 py-2 text-xs italic text-gray-400">
              No edge comments yet. Open an activity and use the Comment item in a
                    ...
                    {edges.map(edge => (
                      <div key={edge.uid}>
                        <div className="mb-0.5 flex items-center gap-1">
                          <span
                            className="grow truncate text-2xs font-mono text-gray-500"
